...
def createpdfs_grade9(parameter_name, parameter_data, parameter_filename):
    ...
    subject1, subject2, subject3, subject4, subject5, subject6 = data1[3], data1[4], data1[5], data1[6], data1[7], data1[8]
    data2 = list(parameter_data.values())
    percentage1, percentage2, percentage3, percentage4, percentage5, percentage6 = data2[3], data2[4], data2[5], data2[6], data2[7], data2[8]
    ...
    records = (
        ...
        (subject6, round(float(percentage6) * 100 / 190))
    ...
    # convert to pdf
    convert("results/demo.docx", "results/9 "+filename+".pdf")
    # remove docx
    os.remove('results/demo.docx')



def createpdfs_grade11(parameter_name, parameter_data, parameter_filename):
    # initialise
    document = Document()
    ...
    document.save('results/demo.docx')
    # convert to pdf
    convert("results/demo.docx", "results/11 "+filename+".pdf")
    # remove docx
    os.remove('results/demo.docx')


def createpdfs_grade12(parameter_name, parameter_data, parameter_filename):
    # initialise
    document = Document()
    ...
    document.save('results/demo.docx')
    # convert to pdf
    convert("results/demo.docx", "results/12 "+filename+".pdf")
    # remove docx
    os.remove('results/demo.docx')
